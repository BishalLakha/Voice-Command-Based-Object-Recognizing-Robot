...
def check_for_match(input):
    ...
    for i in np.array(identify.identify):
        no_match = i
        if (np.allclose(input,no_match,0.00000000,4.00000000)==True) and (flag == 0):
            print "IDENTIFY"
            flag = 1
            exit_flag = 1
            return "identify"
...
##    for i in np.array(cup.cup):
##        no_match = i
##        if (np.allclose(input,no_match,0.00000000,2.90000000)==True) and (flag == 0):
##            print "CUP"
##            flag = 1
##            exit_flag = 1            
##            return "cup"
...
##    
##  
##    for i in np.array((left.left)):
##        no_match = i
##        if (np.allclose(input,no_match,0.00000000,3.30000000)==True) and (flag == 0):
##            print "LEFT"
##            flag = 1
##            print "DIPKAMAL"
##            exit_flag = 1            
